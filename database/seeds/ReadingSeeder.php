...
class ReadingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('readings')->insert([
            ...
            [
                'id' => 3,
                'content' => 'Dear Sirs, <br> Four months ago, I signed up for a premium membership at Fitness First at a monthly fee of $55. When I signed up, I was told that I was free to cancel my membership at any time, for any reason, with no extra payment.
                Since I joined, I have been extremely disappointed in the Fitness First facilities and staff. The locker rooms and swimming pools are poorly maintained and extremely dirty. The Jacuzzi has been out of order for more than a month and repairs on it have not even begun. The Pilates class schedule has been changed several times, without notice, and the instructor never seemed to be fully devoted to the class.
